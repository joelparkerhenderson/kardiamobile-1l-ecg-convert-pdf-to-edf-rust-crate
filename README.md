# KardiaMobile 1L ECG: convert PDF to EDF

KardioMobile 1L is a 1-Lead electrocardiogram (ECG/EKG) handheld device by AliveCor that records heart signals.

The KardioMobile 1L device and corresponding Kardia mobile app have a default export to Portable Document Format (PDF) but not to European Data Format (EDF).

This repository provides a program to convert a KardioMobile 1L ECG from PDF into EDF.
...
- [kardiamobile-1l-ecg.pdf](kardiamobile-1l-ecg.pdf) example data file in PDF.

- [kardiamobile-1l-ecg.edf](kardiamobile-1l-ecg.pdf) example data file in EDF.

About the PDF file:

- The PDF file contains a 1-lead ECG.

- The PDF file ECG trace is on page 2 as vector graphics.
...
- Package: kardiamobile-1l-ecg-convert-pdf-to-edf-rust-crate
- Version: 0.1.0
